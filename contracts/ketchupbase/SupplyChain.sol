...
import "../ketchupaccesscontrol/ConsumerRole.sol";
import "../ketchupaccesscontrol/RetailerRole.sol";
import "../ketchupaccesscontrol/DistributorRole.sol";
import "../ketchupcore/Ownable.sol";
...
contract SupplyChain is Ownable, ConsumerRole, RetailerRole, DistributorRole {
  ...
  function buyItem(uint _upc) public payable 
    ...
    {
      address currentOwner = items[_upc].ownerID;
    // Update the appropriate fields - ownerID, distributorID, itemState
      items[_upc].ownerID = msg.sender;
      items[_upc].distributorID = msg.sender;
      items[_upc].itemState = State.Sold;
    // Transfer money to farmer
      currentOwner.transfer(_upc);
    // emit the appropriate event
      emit Sold(_upc);
  }
