...
contract('SupplyChain', function(accounts) {
    ...
    const originFarmName = "Anku Garg"
    const originFarmInformation = "Mirzapur"
    const originFarmLatitude = "-38.239770"
    const originFarmLongitude = "144.341490"
    var productID = sku + upc
    const productNotes = "Best Tomato used for ketchup"
    ...
    // 1st Test
    it("Testing smart contract function harvestItem() that allows a farmer to harvest tomato", async() => {
    ...
    // 2nd Test
    it("Testing smart contract function processItem() that allows a farmer to process tomato", async() => {
        const supplyChain = await SupplyChain.deployed()
    ...
    // 3rd Test
    it("Testing smart contract function packItem() that allows a farmer to pack tomato", async() => {
        const supplyChain = await SupplyChain.deployed()
    ...
    // 4th Test
    it("Testing smart contract function sellItem() that allows a farmer to sell tomato", async() => {
        const supplyChain = await SupplyChain.deployed()
    ...
    // 5th Test
    it("Testing smart contract function buyItem() that allows a distributor to buy tomato", async() => {
        const supplyChain = await SupplyChain.deployed()
    ...
    // 6th Test
    it("Testing smart contract function shipItem() that allows a distributor to ship tomato", async() => {
        const supplyChain = await SupplyChain.deployed()
    ...
    // // 7th Test
    it("Testing smart contract function receiveItem() that allows a retailer to mark tomato received", async() => {
        const supplyChain = await SupplyChain.deployed()
